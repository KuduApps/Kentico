...
public partial class CMSAdminControls_ImageEditor_BaseImageEditor : CMSUserControl
{
    ...
    /// <summary>
    /// Indicates if savig failed.
    /// </summary>
    public bool SavingFailed
    {
        get
        {
            return this.mSavingFailed;
        }
        set
        {
            this.mSavingFailed = value;
        }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPreview)
        {
            ...
            metaDataEditor.Enabled = this.Enabled;
        }
    }
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        ScriptHelper.RegisterStartupScript(this, this.GetType(), "initialize", ScriptHelper.GetScript(sb.ToString()));
        ...
        // Toggle actions
        this.ToogleActions(this.Enabled & !this.loadingFailed);
        ...
        for (int i = 0; i < ajaxAccordion.Panes.Count; i++)
        {
            ...
            AjaxControlToolkit.AccordionPane pane = ajaxAccordion.Panes[i];

            if (pane.ID == "pnlAccordion6")
            {
                pane.HeaderContainer.Attributes.Add("onclick", "javascript:ShowProperties(true, '" + hdnShowProperties.ClientID + "', '" + lblPropertiesInfo.ClientID + "');");
            }
            else
            {
                pane.HeaderContainer.Attributes.Add("onclick", "javascript:ShowProperties(false, '" + hdnShowProperties.ClientID + "', '" + lblPropertiesInfo.ClientID + "');");
            }
        }
    }
    ...
    private void SetScriptProperties(bool reload)
    {
        ...
        if (!reload)
        {
            ...
            ScriptHelper.RegisterStartupScript(this.Page, typeof(string), "CorrectSize", ScriptHelper.GetScript(script));
        }
        ...
        else
        {
            ...
            ScriptHelper.RegisterStartupScript(this.Page, typeof(string), "NewSize", ScriptHelper.GetScript(script));
        }
    }
    ...
    protected void InitializeStrings(bool reloadName)
    {
        ...
        lblLoadFailed.Visible = this.lblLoadFailed.Visible || loadingFailed || SavingFailed;
    ...
    protected void InitializeFields()
    {
        ...
        if (this.IsPreview)
        {
            ...
            this.metaDataEditor.Enabled = false;
            this.btnChangeMetaData.Enabled = false;
        }
    }
    ...
    {
        if ((tempFile != null) && !lblFileNameValidationFailed.Visible && !lblCropError.Visible)
        {
