...
public partial class CMSAdminControls_Silverlight_MultiFileUploader_MultiFileUploader : CMSUserControl
{
    ...
    /// </summary>
    public string ParentElemID { get; set; }


    /// <summary>
    /// JavaScript function name called after save of new file.
    /// </summary>
    public string AfterSaveJavascript { get; set; }
    ...
    /// </summary>
    public string AttachmentGUIDColumnName { get; set; }
    ...
    /// </summary>
    public string OnUploadProgressChanged { get; set; }
    ...
    /// </summary>
    public string OnUploadBegin { get; set; }
    ...
    private void LoadResources()
    {
        ...
        resources.ForEach(resource =>
            sb.Append(String.Format("window.MFUResourceKeys.push('{0}');window.MFUResources['{0}'] = {1};\n",
                resource,
