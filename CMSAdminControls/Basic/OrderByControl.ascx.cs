...
public partial class CMSAdminControls_Basic_OrderByControl : FormEngineUserControl
{
    ...
    private int[] mControlIdentifiers = null;
    ...
    /// </summary>
    private int[] ControlIdentifiers
    {
        get
        {
    ...
    public override object Value
    {
        get
        {
            ...
            IEnumerable<OrderByRow> rows = from row in orderByRows
                                           ...
                                           group row by row.Column into groupedRows
    ...
    private void SetupControl()
    {
        ...
        else
        {
            ...
            if (ControlIdentifiers.Length > 0)
            {
                count = ControlIdentifiers.Length;

                // Generate controls with used indexes
                for (int i = 0; i < count; i++)
                {
                    AddRow(ControlIdentifiers[i], (i == 0) ? false : true);
                }
            }
            else
            {
                ...
                if (Values != null)
                {
                    ...
                    for (int i = 0; i < count; i++)
                    {
                        ...
                        if (valuesArray.Length > 0)
                        {
                            ...
                            AddRow(i, column, direction, (i == 0) ? false : true);
                        }
                    }
                }
            }
