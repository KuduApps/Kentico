...
Version 2.0 modifications for Help & Manual 5 Premium Pack 1.2
...
u=trim(u);
var g=f.innerHTML;
var o=new RegExp("<span.*?>"+u+"</span>","i");
var m=o.exec(g);
if(m){u=m
...
}if((f.className=="sortablecol")||(f.className.indexOf("sortablecol")!=-1)||(f.className=="defaultsort")){d=true;
if(f.className=="defaultsort"){f.innerHTML='<a href="#" class="sortheader" id="defaultsort'+l+'" title="'+sort_tip+'" onclick="ts_resortTable(this, '+A+');return false;">'+u+'<span class="sortarrow">&nbsp;<img src="'+image_path+v+image_none+'" alt="&darr;"/>&nbsp;</span></a>'
}else{f.innerHTML='<a href="#" class="sortheader" title="'+sort_tip+'" onclick="ts_resortTable(this, '+A+');return false;">'+u+'<span class="sortarrow">&nbsp;<img src="'+image_path+v+image_none+'" alt="&darr;"/>&nbsp;</span></a>'
...
}var B=document.getElementById("defaultsort"+l);
if(B){ts_resortTable(B,x);
if(B.parentNode.getAttribute("hm.descend")=="1"){ts_resortTable(B,x)
...
if(r.getAttribute("sortdir")=="down"){ARROW='&nbsp;<img src="'+image_path+e+image_down+'" alt="&darr;"/>&nbsp;';
g.reverse();
r.setAttribute("sortdir","up")
}else{ARROW='&nbsp;<img src="'+image_path+e+image_up+'" alt="&uarr;"/>&nbsp;';
...
for(var u=0;
u<q.length;
u++){if(q[u].className=="sortarrow"){if(getParent(q[u],"table")==getParent(h,"table")){q[u].innerHTML='&nbsp;<img src="'+image_path+e+image_none+'" alt="&Dagger;" />&nbsp;'
}}}r.innerHTML=ARROW;
if(altTables[l+"alternate"]){alternate(s)
