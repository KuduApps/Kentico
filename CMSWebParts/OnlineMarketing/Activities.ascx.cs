...
public partial class CMSWebParts_OnlineMarketing_Activities : CMSAbstractWebPart
{
    ...
    public string SiteName
    {
        get
        {
            return ValidationHelper.GetString(this.GetValue("Site"), "");
        }
        set
        {
    ...
    public string ActivityType
    {
        get
        {
            return ValidationHelper.GetString(this.GetValue("ActivityType"), "");
        }
        set
        {
            this.SetValue("ActivityType", value);
        }
    }
    ...
    public int DateInterval
    {
        get
        {
            return ValidationHelper.GetInteger(this.GetValue("DateInterval"), 0);
        }
        set
        {
            this.SetValue("DateInterval", value);
        }
    }
    ...
    public override void OnContentLoaded()
    {
        ...
        if (CMSContext.CurrentUser.IsAuthorizedPerResource("CMS.ContactManagement", "ReadActivities"))
        {
            SetupControl();
        }
        else
