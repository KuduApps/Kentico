...
function showInfo(map, pushpin, zoom) {
    ...
    var randReplacement = '##Description##';
    var infoboxOptions = { width: infoWidth, height: infoHeight, title: pushpin.title, description: randReplacement, offset: new MM.Point(0, pushpin.getHeight()) };
    ...
    replaceContent("infobox-info", randReplacement, pushpin.description);
}
