...
public partial class CMSWebParts_Media_RealMedia : CMSAbstractWebPart
{
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            {
                ltlPlaceholder.Text = "<table style=\"border: 1px solid Gray;background-color:#eee;width:" + Width + "px;height:" + Height + "px\"><tr><td style=\"vertical-align:middle;text-align:center;color:Gray;\">" + GetString("global.herecomesvideo").ToUpper() + "</td></tr></table>";
            }
            else
            {
                ...
                if (AutoActivation)
                {
                    ...
                    ScriptHelper.RegisterScriptFile(this.Page, "~/CMSWebParts/Media/RealMedia_files/video.js");
                ...
                else
                {
                    ...
                    ltlPlaceholder.Text = "<div class=\"VideoLikeContent\" ><div class=\"Video\"><object classid=\"clsid:CFCDAA03-8BE4-11CF-B84B-0020AFBBCCFA\" width=\"" + Width + "\" height=\"" + Height + "\">" +
                          ...
                          "<param name=\"autostart\" value=\"" + Autostart.ToString().ToLower() + "\" />" +
    ...
    private string BuildScriptBlock()
    {
        string scriptBlock = string.Format("LoadRealMedia('RMPlaceholder_{0}', '{1}', {2}, {3}, '{4}', '{5}', '{6}', {7}, {8});",
            ...
            Width,
            Height,
            ShowControls.ToString().ToLowerInvariant(),
            Autostart.ToString().ToLowerInvariant(), 
