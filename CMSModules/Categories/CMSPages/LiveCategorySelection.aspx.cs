...
public partial class CMSModules_Categories_CMSPages_LiveCategorySelection : CMSLiveModalPage
{
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        string titleText = GetString("categories.select");
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        {
            lnkEdit.OnClientClick = "modalDialog('" + ResolveUrl("~/CMSModules/Categories/CMSPages/CategoryEdit.aspx?categoryId=" + categoryId) + "', 'CategoryEdit', 500, 450); return false;";
        }
        ...
        if (lnkNew.Enabled)
        {
            lnkNew.OnClientClick = "modalDialog('" + ResolveUrl("~/CMSModules/Categories/CMSPages/CategoryEdit.aspx?parentId=" + categoryId + createPersonal) + "', 'CategoryEdit', 500, 450); return false;";
        }
    }
