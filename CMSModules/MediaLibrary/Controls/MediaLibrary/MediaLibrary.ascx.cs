...
public partial class CMSModules_MediaLibrary_Controls_MediaLibrary_MediaLibrary : CMSAdminItemsControl
{
    ...
    {
        string baseUrl = ResolveUrl(GetCopyMoveDialogUrl());
        DialogUrlBuilder builder = new DialogUrlBuilder(baseUrl).WithAction("move").WithFolderPath(LastFolderPath).WithLibraryId(LibraryID);
        if (includeAllFiles)
        {
            builder.WithAllFiles();
        }
    ...
    private class DialogUrlBuilder
    {
        ...
        /// </summary>
        private bool mHasParameters = false;
        ...
        public DialogUrlBuilder(string baseUrl)
        {
        ...
        {
            AddParameter("folderpath", CMSDialogHelper.EscapeUrlParameter(MediaLibraryHelper.EnsurePath(folderPath)));
            return this;
        }
        ...
        {
            AddParameter("libraryid", libraryId.ToString("D", System.Globalization.CultureInfo.InvariantCulture));
            return this;
        }
        ...
        {
            AddParameter("files", CMSDialogHelper.EscapeUrlParameter(String.Join("|", fileNames.ToArray())));
            return this;
        }
        ...
        {
            mBuilder.Append(mHasParameters ? "&" : "?").Append(name).Append("=").Append(value);
            mHasParameters = true;
        }
