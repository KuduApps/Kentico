...
public partial class CMSModules_Notifications_Controls_NotificationSubscription_NotificationSubscription : CMSNotificationSubscription
{
    ...
    public override string Validate()
    {
        ...
        {
            UserInfo ui = UserInfoProvider.GetUserInfo(this.EventUserID);
    ...
    {
        string errorMessage = this.Subscribe();
        if (String.IsNullOrEmpty(errorMessage))
        {
            this.lblInfo.Text = GetString("notifications.subscription.successful");
