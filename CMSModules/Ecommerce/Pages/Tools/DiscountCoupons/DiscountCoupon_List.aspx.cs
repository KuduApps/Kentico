...
public partial class CMSModules_Ecommerce_Pages_Tools_DiscountCoupons_DiscountCoupon_List : CMSDiscountCouponsPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        actions[0, 1] = GetString("DiscounCoupon_List.NewItemCaption");
        actions[0, 2] = null;
        actions[0, 3] = ResolveUrl("DiscountCoupon_New.aspx?siteId=" + SelectSite.SiteID);
        actions[0, 4] = null;
        actions[0, 5] = GetImageUrl("Objects/Ecommerce_DiscountCoupon/add.png");
        this.hdrActions.Actions = actions;

        // Set master title
        this.CurrentMaster.Title.TitleText = GetString("DiscounCoupon_Edit.ItemListLink");
        this.CurrentMaster.Title.TitleImage = GetImageUrl("Objects/Ecommerce_DiscountCoupon/object.png");
        this.CurrentMaster.Title.HelpTopicName = "discount_coupons_list";
    ...
    protected void gridElem_OnAction(string actionName, object actionArgument)
    {
        ...
        else if (actionName == "delete")
        {
            ...
            // Nothing to delete
            if (discountCouponInfoObj == null) return;
