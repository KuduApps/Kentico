...
<div class="BlockContent">
                ...
                <td>
                    <table id="tblSignIn">
                        <tr>
                            ...
                            <td>
                                <cms:ExtendedTextBox ID="txtUsername" runat="server" CssClass="TextBoxField" MaxLength="100"
                ...
                <tr>
                    <td>
                        <table id="tblAnonymous">
                            ...
                            <tr>
                                <td class="FieldLabel">
                                    <asp:Label ID="lblEmail3" AssociatedControlID="txtEmail3" runat="server" EnableViewState="false" />
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="FieldLabel">
                                    <asp:Label ID="lblCompany2" AssociatedControlID="txtCompany2" runat="server" EnableViewState="false" />
                                </td>
                                <td>
    ...
    <asp:PlaceHolder runat="server" ID="plcEditCustomer" EnableViewState="false">
        <table>
            ...
            <tr>
                <td class="FieldLabel" style="width: 170px">
                    <asp:Label ID="lblEditEmail" AssociatedControlID="txtEditEmail" runat="server" EnableViewState="false" />
                </td>
                <td>
