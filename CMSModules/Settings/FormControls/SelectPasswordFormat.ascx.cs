...
public partial class CMSModules_Settings_FormControls_SelectPasswordFormat : FormEngineUserControl
{
    ...
    private void ReloadData()
    {
        ...
        {
            this.drpSelectFormat.Items.Add(new ListItem(GetString("general.plaintext"), ""));
            this.drpSelectFormat.Items.Add(new ListItem(GetString("settings.sha1"), "SHA1"));
            this.drpSelectFormat.Items.Add(new ListItem(GetString("settings.sha2"), "SHA2"));
            this.drpSelectFormat.Items.Add(new ListItem(GetString("settings.sha2salt"), "SHA2SALT"));
        }
