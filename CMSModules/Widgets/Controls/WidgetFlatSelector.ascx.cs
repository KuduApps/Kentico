...
public partial class CMSModules_Widgets_Controls_WidgetFlatSelector : CMSAdminControl
{
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        if (SelectGroupWidgets)
        {
            ...
            if (!currentUser.IsGroupAdministrator(this.GroupID) && ((CMSContext.ViewMode != ViewModeEnum.Design) || ((CMSContext.ViewMode == ViewModeEnum.Design) && (!currentUser.IsAuthorizedPerResource("CMS.Design", "Design")))))
            {
