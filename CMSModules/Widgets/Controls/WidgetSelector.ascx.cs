...
public partial class CMSModules_Widgets_Controls_WidgetSelector : CMSAdminControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        treeElem.OnItemSelected += new CMSModules_Widgets_Controls_WidgetTree.ItemSelectedEventHandler(treeElem_OnItemSelected);
        ...
        else if (!String.IsNullOrEmpty(this.ZoneId))
        {
            // Get pageinfo
            PageInfo pi = null;
            try
            ...
            {
                WidgetZoneTypeEnum zoneType = this.ZoneType;
