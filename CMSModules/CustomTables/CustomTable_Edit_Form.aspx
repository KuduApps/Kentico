<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="CMSModules_CustomTables_CustomTable_Edit_Form" Theme="Default" ValidateRequest="false"
    EnableEventValidation="false" CodeFile="CustomTable_Edit_Form.aspx.cs" %>
...
<head runat="server" enableviewstate="false">
    <title>Custom table edit - Form</title>
    <style type="text/css">
        body
        {
            margin: 0px;
