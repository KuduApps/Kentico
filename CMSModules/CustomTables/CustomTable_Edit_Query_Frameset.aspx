...
<frameset border="0" rows="<%= TabsBreadFrameHeight %>, *" id="rowsFrameset">
    <frame name="ctq_edit_menu" src="CustomTable_Edit_Query_Header.aspx?<%=Request.QueryString %>"
        scrolling="no" frameborder="0" noresize="noresize" />
    <frame name="ctq_edit_content" src="CustomTable_Edit_Query_Edit.aspx?<%=Request.QueryString %>"
        frameborder="0" />
