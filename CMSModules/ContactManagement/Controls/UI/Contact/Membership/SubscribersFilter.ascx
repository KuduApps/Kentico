<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSModules_ContactManagement_Controls_UI_Contact_Membership_SubscribersFilter"
    CodeFile="SubscribersFilter.ascx.cs" %>
...
<asp:Panel ID="pnl" runat="server" DefaultButton="btnSearch">
    <table cellpadding="0" cellspacing="2">
        ...
        <tr>
            ...
            <td>
                <cms:TextSimpleFilter ID="fltFirstName" runat="server" Column="SubscriberFirstName" />
            </td>
        </tr>
        <tr>
            <td class="ContactLabel">
            ...
            <td>
                <cms:TextSimpleFilter ID="fltLastName" runat="server" Column="SubscriberLastName" />
            </td>
        </tr>
        <tr>
            <td class="ContactLabel">
            ...
            <td>
                <cms:TextSimpleFilter ID="fltEmail" runat="server" Column="SubscriberEmail" />
            </td>
        </tr>        
        <tr>
            <td>
