...
public partial class CMSModules_ImportExport_Controls_Import_Site_board_board : ImportExportControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
         ...
         if (!ExistingSite)
         {
             ...
             this.chkObject.Text = GetString("CMSImport_Board.ImportBoardMessages");
         }
    }
    ...
    public override void ReloadData()
    {
        if (!ExistingSite)
        {
            this.chkObject.Checked = ValidationHelper.GetBoolean(Settings.GetSettings(ImportExportHelper.SETTINGS_BOARD_MESSAGES), true);
        }
    }
}
