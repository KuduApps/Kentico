...
public partial class CMSModules_ImportExport_Controls_Import_cms_customtable : ImportExportControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.chkObject.Text = GetString("CMSImport_CustomTables.ImportCustomTable");
        this.lblInfo.Text = GetString("CMSImport_CustomTables.InfoLabel");
    }
    ...
    {
        this.chkObject.Checked = ValidationHelper.GetBoolean(Settings.GetSettings(ImportExportHelper.SETTINGS_CUSTOMTABLE_DATA), !ExistingSite);
    }
}
