...
public partial class CMSModules_Forums_Controls_ForumBreadcrumbs : ForumViewer
{
    ...
    public virtual string GenerateBreadcrumbs()
    {
        ...
        if ((this.DisplayGroup) && (ForumContext.CurrentGroup != null))
        {
            ...
            result.Append(CreateItem(grUrl, HTMLHelper.HTMLEncode(ResHelper.LocalizeString(ForumContext.CurrentGroup.GroupDisplayName)), (ForumContext.CurrentForum != null) ? true : this.UseLinkForCurrentItem));
            separator = true;
        }
        else
        {
        ...
        if ((this.DisplayThreads) && (ForumContext.CurrentGroup != null || ForumContext.CurrentThread != null) && (ForumContext.CurrentForum != null) && (ForumContext.CurrentForum.ForumID > 0))
        {
            ...
            result.Append(CreateItem(frUrl, HTMLHelper.HTMLEncode(ResHelper.LocalizeString(ForumContext.CurrentForum.ForumDisplayName)), (ForumContext.CurrentThread != null) ? true : this.UseLinkForCurrentItem));
            separator = true;
        }
        else
        {
        ...
        {
            result.Append(this.BreadcrumbSeparator);
            result.Append(CreateItem(URLCreator("threadid", ForumContext.CurrentThread.PostId.ToString(), false, ForumContext.CurrentThread), HTMLHelper.HTMLEncode(ForumContext.CurrentThread.PostSubject), this.UseLinkForCurrentItem));
        }
