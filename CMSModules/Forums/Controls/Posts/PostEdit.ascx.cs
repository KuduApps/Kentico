...
public partial class CMSModules_Forums_Controls_Posts_PostEdit : CMSAdminEditControl
{
    ...
    /// <summary>
    /// Gets or sete post id of post which should be edited.
    /// </summary>
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        if ((fi.ForumRequireEmail || chkSubscribe.Checked || (txtEmail.Text != String.Empty)) && result == "")
        {
            ...
            if (!String.IsNullOrEmpty(result))
            {
                ...
                {
                    lblError.Text = GetString("Forums.Emailsubscribe");
                }
                this.Visible = true;
                return;
            }
        ...
        if (String.IsNullOrEmpty(result))
        {
            ...
            if ((chkSubscribe.Checked) && (!String.IsNullOrEmpty(editPi.PostUserMail)))
            {
                ...
                fsi.SubscriptionForumID = this.ForumID;
    ...
    protected void btnPreview_Click(object sender, EventArgs e)
    {
        ...
        fp.PostForumID = (editPi != null) ? editPi.PostForumID : this.ForumID;
