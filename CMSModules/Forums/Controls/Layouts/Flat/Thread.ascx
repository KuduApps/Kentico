...
<div class="Forum" id="<%= this.ClientID %>">
    <div class="ForumFlat">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr style="border: medium none;">
                                                                    <td style="border: medium none; padding-right: 5px; vertical-align: top;" class="UserAvatar">
                                                                        ...
                                                                        <%# IFCompare((this.EnableMessaging || this.EnableFriendship)&&(ValidationHelper.GetInteger(Eval("PostUserID"),0) > 0),"<div class=\"PostExtendedActions\">","")  %>
                                                                        <%# IFCompare((this.EnableMessaging) && (ValidationHelper.GetInteger(Eval("PostUserID"), 0) > 0), "<a class=\"SendMessage\" onclick=\"PrivateMessage(" + Eval("PostUserID") + "); return false;\" title=\"" + ResHelper.GetString("sendmessage.sendmessage") + "\"  href=\"#\"><span>" + ResHelper.GetString("sendmessage.sendmessage") + "</span></a>", "")%>
                                                                        <%# IFCompare((this.EnableFriendship) && (ValidationHelper.GetInteger(Eval("PostUserID"), 0) > 0), "<a class=\"Friendship\" onclick=\"FriendshipRequest(" + Eval("PostUserID") + "); return false;\" title=\"" + ResHelper.GetString("friends.requestfriendship") + "\" href=\"#\"><span>" + ResHelper.GetString("friends.requestfriendship") + "</span></a>", "")%>
                                                                        <%# IFCompare((this.EnableMessaging || this.EnableFriendship)&&(ValidationHelper.GetInteger(Eval("PostUserID"),0) > 0),"</div>","")  %>
                                                                    </td>
                                                                    <td style="border: medium none; padding: 5px; width: 100%" class="Content">
                                                                        ...
                                                                        <div style="float: right;">
                                                                            ...
                                                                            <cms:AbuseReport ID="ucAbuse" runat="server" ReportObjectType="forums.forumpost"
                                                                                ...
                                                                                ReportTitle='<%# CMS.GlobalHelper.ResHelper.GetString("Forums_WebInterface_ForumPost.AbuseReport", CMS.SettingsProvider.SettingsKeyProvider.GetStringValue(CMSContext.CurrentSiteName + ".CMSDefaultCultureCode")) + Eval("PostText") %>'
                                                                                CssClass="ActionLink" />
                                                                        </div>
                                                                        <div style="clear: both;">
                                                                        </div>
