...
public partial class CMSModules_Content_Controls_Dialogs_General_FileSystemDialogFooter : CMSUserControl
{
    ...
    private void SetupControls()
    {
        ...
        ScriptHelper.RegisterScriptFile(this.Page, "Dialogs/FileSystem.js");

        this.btnInsert.ResourceString = GetString("general.select");
        this.btnCancel.ResourceString = GetString("general.cancel");
