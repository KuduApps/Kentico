...
public partial class CMSModules_PortalEngine_Controls_Layout_PageTemplateSelector : CMSAdminControl
{
    ...
    /// <summary>
    /// If enabled adhoc templates will be diplayed in selector.
    /// </summary>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        treeElem.OnItemSelected += new CMSModules_PortalEngine_Controls_Layout_PageTemplateTree.ItemSelectedEventHandler(treeElem_OnItemSelected);        
