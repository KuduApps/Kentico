...
<frameset border="0" rows="<%= TabsBreadFrameHeight %>, *" framespacing="0" id="rowsFrameset">
    <frame name="webparteditheader" src="WebPart_Edit_Header.aspx?webpartid=<%=Request.QueryString["webpartid"]%> "
        scrolling="no" frameborder="0" noresize="noresize" />
    <frame name="webparteditcontent" src="WebPart_Edit_General.aspx?webpartid=<%=Request.QueryString["webpartid"]%> "
        frameborder="0" />
