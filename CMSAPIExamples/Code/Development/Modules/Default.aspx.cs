...
public partial class CMSAPIExamples_Code_Development_Modules_Default : CMSAPIExamplePage
{
    ...
    {
        // Module
        this.apiCreateModule.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateModule);
        this.apiGetAndUpdateModule.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateModule);
        this.apiGetAndBulkUpdateModules.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateModules);
        this.apiDeleteModule.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteModule);

        // Module on site
        this.apiAddModuleToSite.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(AddModuleToSite);
        this.apiGetAndBulkUpdateSiteModules.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateSiteModules);
        this.apiRemoveModuleFromSite.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(RemoveModuleFromSite);

        // Permission
        this.apiCreatePermission.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreatePermission);
        this.apiGetAndUpdatePermission.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdatePermission);
        this.apiGetAndBulkUpdatePermissions.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdatePermissions);
        this.apiDeletePermission.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeletePermission);

        // Role permission
        this.apiAddPermissionToRole.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(AddPermissionToRole);        
        this.apiRemovePermissionFromRole.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(RemovePermissionFromRole);

        // UI element
        this.apiCreateUIElement.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateUIElement);
        this.apiGetAndUpdateUIElement.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateUIElement);
        this.apiGetAndBulkUpdateUIElements.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateUIElements);
        this.apiDeleteUIElement.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteUIElement);

        // Role UI element
        this.apiAddUIElementToRole.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(AddUIElementToRole);
        this.apiRemoveUIElementFromRole.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(RemoveUIElementFromRole);
    }
    ...
    public override void RunAll()
    {
        ...
        // Module
        this.apiCreateModule.Run();
        this.apiGetAndUpdateModule.Run();
        this.apiGetAndBulkUpdateModules.Run();

        // Module on site
        this.apiAddModuleToSite.Run();
        this.apiGetAndBulkUpdateSiteModules.Run();

        // Permission
        this.apiCreatePermission.Run();
        this.apiGetAndUpdatePermission.Run();
        this.apiGetAndBulkUpdatePermissions.Run();

        // Role permission
        this.apiAddPermissionToRole.Run();        

        // UI element
        this.apiCreateUIElement.Run();
        this.apiGetAndUpdateUIElement.Run();
        this.apiGetAndBulkUpdateUIElements.Run();

        // Role UI element
        this.apiAddUIElementToRole.Run();        
    }
    ...
    public override void CleanUpAll()
    {
        ...
        // Role UI element
        this.apiRemoveUIElementFromRole.Run();

        // UI element
        this.apiDeleteUIElement.Run();

        // Role permission
        this.apiRemovePermissionFromRole.Run();

        // Permission
        this.apiDeletePermission.Run();

        // Module on site
        this.apiRemoveModuleFromSite.Run();

        // Module
        this.apiDeleteModule.Run();
    }
