...
public partial class CMSAPIExamples_Code_Development_Widgets_Default : CMSAPIExamplePage
{
    ...
    {
        // Widget
        this.apiCreateWidget.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateWidget);
        this.apiGetAndUpdateWidget.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateWidget);
        this.apiGetAndBulkUpdateWidgets.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateWidgets);
        this.apiDeleteWidget.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteWidget);

        // Widget category
        this.apiCreateWidgetCategory.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateWidgetCategory);
        this.apiGetAndUpdateWidgetCategory.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateWidgetCategory);
        this.apiGetAndBulkUpdateWidgetCategories.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateWidgetCategories);
        this.apiDeleteWidgetCategory.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteWidgetCategory);
    
        // Widget security
        this.apiAddWidgetToRole.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(AddWidgetToRole);
        this.apiSetSecurityLevel.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(SetSecurityLevel);
        this.apiRemoveWidgetFromRole.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(RemoveWidgetFromRole);
    }
    ...
    public override void RunAll()
    {
        ...
        // Widget category
        this.apiCreateWidgetCategory.Run();
        this.apiGetAndUpdateWidgetCategory.Run();
        this.apiGetAndBulkUpdateWidgetCategories.Run();

        // Widget
        this.apiCreateWidget.Run();
        this.apiGetAndUpdateWidget.Run();
        this.apiGetAndBulkUpdateWidgets.Run();

        // Widget security
        this.apiAddWidgetToRole.Run();
        this.apiSetSecurityLevel.Run();
    }
    ...
    public override void CleanUpAll()
    {
        ...
        // Widget role
        this.apiRemoveWidgetFromRole.Run();

        // Widget
        this.apiDeleteWidget.Run();

        // Widget category
        this.apiDeleteWidgetCategory.Run();
    }
