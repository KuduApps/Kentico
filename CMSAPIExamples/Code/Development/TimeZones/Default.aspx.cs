...
public partial class CMSAPIExamples_Code_Development_TimeZones_Default : CMSAPIExamplePage
{
    ...
    {
        // Timezone
        this.apiCreateTimezone.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateTimezone);
        this.apiGetAndUpdateTimezone.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateTimezone);
        this.apiGetAndBulkUpdateTimezones.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateTimezones);
        this.apiDeleteTimezone.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteTimezone);
        this.apiConvertTime.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(ConvertTime);
    }
    ...
    public override void RunAll()
    {
        ...
        // Timezone
        this.apiCreateTimezone.Run();
        this.apiGetAndUpdateTimezone.Run();
        this.apiGetAndBulkUpdateTimezones.Run();
        this.apiConvertTime.Run();
    }
