...
public partial class CMSAPIExamples_Code_Development_WebTemplates_Default : CMSAPIExamplePage
{
    ...
    {
        // Web template
        this.apiCreateWebTemplate.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateWebTemplate);
        this.apiGetAndUpdateWebTemplate.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateWebTemplate);
        this.apiGetAndMoveWebTemplateDown.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndMoveWebTemplateDown);
        this.apiGetAndMoveWebTemplateUp.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndMoveWebTemplateUp);
        this.apiGetAndBulkUpdateWebTemplates.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateWebTemplates);
        this.apiDeleteWebTemplate.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteWebTemplate);
    }
    ...
    public override void RunAll()
    {
        ...
        // Web template
        this.apiCreateWebTemplate.Run();
        this.apiGetAndUpdateWebTemplate.Run();
        this.apiGetAndMoveWebTemplateUp.Run();
        this.apiGetAndMoveWebTemplateDown.Run();
        this.apiGetAndBulkUpdateWebTemplates.Run();
    }
