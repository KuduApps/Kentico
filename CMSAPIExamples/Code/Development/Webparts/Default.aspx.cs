...
public partial class CMSAPIExamples_Code_Development_Webparts_Default : CMSAPIExamplePage
{
    ...
    {
        // Web part
        this.apiCreateWebPart.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateWebPart);
        this.apiGetAndUpdateWebPart.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateWebPart);
        this.apiGetAndBulkUpdateWebParts.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateWebParts);
        this.apiDeleteWebPart.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteWebPart);

        // Web part layout
        this.apiCreateWebPartLayout.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateWebPartLayout);
        this.apiGetAndUpdateWebPartLayout.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateWebPartLayout);
        this.apiGetAndBulkUpdateWebPartLayouts.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateWebPartLayouts);
        this.apiDeleteWebPartLayout.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteWebPartLayout);

        // Web part category
        this.apiCreateWebPartCategory.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateWebPartCategory);
        this.apiGetAndUpdateWebPartCategory.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateWebPartCategory);
        this.apiGetAndBulkUpdateWebPartCategories.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateWebPartCategories);
        this.apiDeleteWebPartCategory.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteWebPartCategory);

        // Web part container
        this.apiCreateWebPartContainer.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateWebPartContainer);
        this.apiGetAndUpdateWebPartContainer.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateWebPartContainer);
        this.apiGetAndBulkUpdateWebPartContainers.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateWebPartContainers);
        this.apiDeleteWebPartContainer.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteWebPartContainer);

        // Web part container on site
        this.apiAddWebPartContainerToSite.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(AddWebPartContainerToSite);
        this.apiRemoveWebPartContainerFromSite.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(RemoveWebPartContainerFromSite);
    }
    ...
    public override void RunAll()
    {
        ...
        // Web part category
        this.apiCreateWebPartCategory.Run();
        this.apiGetAndUpdateWebPartCategory.Run();
        this.apiGetAndBulkUpdateWebPartCategories.Run();

        // Web part
        this.apiCreateWebPart.Run();
        this.apiGetAndUpdateWebPart.Run();
        this.apiGetAndBulkUpdateWebParts.Run();

        // Web part layout
        this.apiCreateWebPartLayout.Run();
        this.apiGetAndUpdateWebPartLayout.Run();
        this.apiGetAndBulkUpdateWebPartLayouts.Run();

        // Web part container
        this.apiCreateWebPartContainer.Run();
        this.apiGetAndUpdateWebPartContainer.Run();
        this.apiGetAndBulkUpdateWebPartContainers.Run();

        // Web part container on site
        this.apiAddWebPartContainerToSite.Run();
    }
    ...
    public override void CleanUpAll()
    {
        ...
        // Web part container on site
        this.apiRemoveWebPartContainerFromSite.Run();

        // Web part container
        this.apiDeleteWebPartContainer.Run();

        // Web part layout
        this.apiDeleteWebPartLayout.Run();

        // Web part
        this.apiDeleteWebPart.Run();

        // Web part category
        this.apiDeleteWebPartCategory.Run();
    }
