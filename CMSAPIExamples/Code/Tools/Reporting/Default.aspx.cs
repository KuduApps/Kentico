...
public partial class CMSAPIExamples_Code_Tools_Reporting_Default : CMSAPIExamplePage
{
    ...
    {
        // Report category
        this.apiCreateReportCategory.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateReportCategory);
        this.apiGetAndUpdateReportCategory.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateReportCategory);
        this.apiGetAndBulkUpdateReportCategories.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateReportCategories);
        this.apiDeleteReportCategory.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteReportCategory);
        // Report
        this.apiCreateReport.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateReport);
        this.apiGetAndUpdateReport.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateReport);
        this.apiGetAndBulkUpdateReports.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateReports);
        this.apiDeleteReport.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteReport);

        // Report graph
        this.apiCreateReportGraph.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateReportGraph);
        this.apiGetAndUpdateReportGraph.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateReportGraph);
        this.apiGetAndBulkUpdateReportGraphs.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateReportGraphs);
        this.apiDeleteReportGraph.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteReportGraph);

        // Report table
        this.apiCreateReportTable.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateReportTable);
        this.apiGetAndUpdateReportTable.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateReportTable);
        this.apiGetAndBulkUpdateReportTables.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateReportTables);
        this.apiDeleteReportTable.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteReportTable);

        // Report value
        this.apiCreateReportValue.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateReportValue);
        this.apiGetAndUpdateReportValue.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateReportValue);
        this.apiGetAndBulkUpdateReportValues.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateReportValues);
        this.apiDeleteReportValue.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteReportValue);

        // Report actions
        this.apiInsertElementsToLayout.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(InsertElementsToLayout);
    }
    ...
    public override void RunAll()
    {
        ...
        // Report category
        this.apiCreateReportCategory.Run();
        this.apiGetAndUpdateReportCategory.Run();
        this.apiGetAndBulkUpdateReportCategories.Run();

        // Report
        this.apiCreateReport.Run();
        this.apiGetAndUpdateReport.Run();
        this.apiGetAndBulkUpdateReports.Run();

        // Report graph
        this.apiCreateReportGraph.Run();
        this.apiGetAndUpdateReportGraph.Run();
        this.apiGetAndBulkUpdateReportGraphs.Run();

        // Report table
        this.apiCreateReportTable.Run();
        this.apiGetAndUpdateReportTable.Run();
        this.apiGetAndBulkUpdateReportTables.Run();

        // Report value
        this.apiCreateReportValue.Run();
        this.apiGetAndUpdateReportValue.Run();
        this.apiGetAndBulkUpdateReportValues.Run();

        // Report actions
        this.apiInsertElementsToLayout.Run();
    }
    ...
    public override void CleanUpAll()
    {
        ...
        // Report graph
        this.apiDeleteReportGraph.Run();

        // Report table
        this.apiDeleteReportTable.Run();

        // Report value
        this.apiDeleteReportValue.Run();

        // Report
        this.apiDeleteReport.Run();

        // Report category
        this.apiDeleteReportCategory.Run();
