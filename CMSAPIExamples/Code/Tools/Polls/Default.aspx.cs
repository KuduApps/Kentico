...
public partial class CMSAPIExamples_Code_Tools_Polls_Default : CMSAPIExamplePage
{
    ...
    {
        // Poll
        this.apiCreatePoll.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreatePoll);
        this.apiGetAndUpdatePoll.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdatePoll);
        this.apiGetAndBulkUpdatePolls.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdatePolls);
        this.apiDeletePoll.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeletePoll);

        // Answer
        this.apiCreateAnswer.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateAnswer);
        this.apiGetAndUpdateAnswer.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateAnswer);
        this.apiGetAndBulkUpdateAnswers.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateAnswers);
        this.apiDeleteAnswer.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteAnswer);

        // Poll on site
        this.apiAddPollToSite.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(AddPollToSite);
        this.apiRemovePollFromSite.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(RemovePollFromSite);
    }
    ...
    public override void RunAll()
    {
        ...
        // Poll
        this.apiCreatePoll.Run();
        this.apiGetAndUpdatePoll.Run();
        this.apiGetAndBulkUpdatePolls.Run();

        // Answer
        this.apiCreateAnswer.Run();
        this.apiGetAndUpdateAnswer.Run();
        this.apiGetAndBulkUpdateAnswers.Run();

        // Poll on site
        this.apiAddPollToSite.Run();
    ...
    public override void CleanUpAll()
    {
        ...
        // Poll on site
        this.apiRemovePollFromSite.Run();

        // Answer
        this.apiDeleteAnswer.Run();

        // Poll
        this.apiDeletePoll.Run();
    }
