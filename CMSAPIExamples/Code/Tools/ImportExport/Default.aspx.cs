...
public partial class CMSAPIExamples_Code_Tools_ImportExport_Default : CMSAPIExamplePage
{
    ...
    {
        // Import.
        this.apiImportObject.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(ImportObject);
        this.apiImportSite.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(ImportSite);

        // Export
        this.apiExportObject.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(ExportObject);
        this.apiExportSite.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(ExportSite);

        // Delete imported
        this.apiDeleteImportedObject.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteImportedObject);
        this.apiDeleteImportedSite.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteImportedSite);
        this.apiDeletePackages.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeletePackages);
    }
    ...
    public override void RunAll()
    {
        ...
        // Import
        this.apiImportObject.Run();
        this.apiImportSite.Run();

        // Export
        this.apiExportObject.Run();
        this.apiExportSite.Run();
    }
    ...
    public override void CleanUpAll()
    {
        ...
        // Delete imported
        this.apiDeleteImportedObject.Run();
        this.apiDeleteImportedSite.Run();
        this.apiDeletePackages.Run();
    }
