...
public partial class CMSAPIExamples_Code_Community_Forums_Default : CMSAPIExamplePage
{
    ...
    {
        // Forum group
        this.apiCreateForumGroup.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateForumGroup);
        this.apiGetAndUpdateForumGroup.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateForumGroup);
        this.apiGetAndBulkUpdateForumGroups.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateForumGroups);
        this.apiDeleteForumGroup.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteForumGroup);

        // Forum
        this.apiCreateForum.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateForum);
        this.apiGetAndUpdateForum.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateForum);
        this.apiGetAndBulkUpdateForums.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateForums);
        this.apiDeleteForum.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteForum);

        // Forum post
        this.apiCreateForumPost.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateForumPost);
        this.apiGetAndUpdateForumPost.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateForumPost);
        this.apiGetAndBulkUpdateForumPosts.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateForumPosts);
        this.apiDeleteForumPost.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteForumPost);
    }
    ...
    public override void RunAll()
    {
        ...
        // Forum group
        this.apiCreateForumGroup.Run();
        this.apiGetAndUpdateForumGroup.Run();
        this.apiGetAndBulkUpdateForumGroups.Run();

        // Forum
        this.apiCreateForum.Run();
        this.apiGetAndUpdateForum.Run();
        this.apiGetAndBulkUpdateForums.Run();

        // Forum post
        this.apiCreateForumPost.Run();
        this.apiGetAndUpdateForumPost.Run();
        this.apiGetAndBulkUpdateForumPosts.Run();
    }
    ...
    public override void CleanUpAll()
    {
        ...
        // Forum post
        this.apiDeleteForumPost.Run();

        // Forum
        this.apiDeleteForum.Run();

        // Forum group
        this.apiDeleteForumGroup.Run();
    }
