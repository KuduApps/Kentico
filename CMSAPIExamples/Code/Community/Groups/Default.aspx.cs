...
public partial class CMSAPIExamples_Code_Community_Groups_Default : CMSAPIExamplePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        // Group member
        this.apiCreateGroupMember.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateGroupMember);
        this.apiGetAndUpdateGroupMember.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateGroupMember);
        this.apiGetAndBulkUpdateGroupMembers.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateGroupMembers);
        this.apiDeleteGroupMember.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteGroupMember);
        this.apiCreateInvitation.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateInvitation);

        // Group
        this.apiCreateGroup.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateGroup);
        this.apiGetAndUpdateGroup.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateGroup);
        this.apiGetAndBulkUpdateGroups.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateGroups);
        this.apiDeleteGroup.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteGroup);
    }
    ...
    public override void RunAll()
    {
        ...
        // Group
        this.apiCreateGroup.Run();
        this.apiGetAndUpdateGroup.Run();
        this.apiGetAndBulkUpdateGroups.Run();

        // Group member
        this.apiCreateGroupMember.Run();
        this.apiGetAndUpdateGroupMember.Run();
        this.apiGetAndBulkUpdateGroupMembers.Run();
        this.apiCreateInvitation.Run();
    }
    ...
    public override void CleanUpAll()
    {
        ...
        // Group member
        this.apiDeleteGroupMember.Run();

        // Group
        this.apiDeleteGroup.Run();
    }
