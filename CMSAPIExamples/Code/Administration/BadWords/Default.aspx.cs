...
public partial class CMSAPIExamples_Code_Administration_BadWords_Default : CMSAPIExamplePage
{
    ...
    {
        // Bad word
        this.apiCreateBadWord.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateBadWord);
        this.apiGetAndUpdateBadWord.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateBadWord);
        this.apiGetAndBulkUpdateBadWords.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateBadWords);
        this.apiDeleteBadWord.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteBadWord);

        // Performing bad word checks
        this.apiCheckSingleBadWord.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CheckSingleBadWord);
        this.apiCheckAllBadWords.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CheckAllBadWords);
    }
    ...
    public override void RunAll()
    {
        ...
        // Bad word
        this.apiCreateBadWord.Run();
        this.apiGetAndUpdateBadWord.Run();
        this.apiGetAndBulkUpdateBadWords.Run();

        // Performing bad word checks
        this.apiCheckSingleBadWord.Run();
        this.apiCheckAllBadWords.Run();
    }
