...
public partial class CMSAPIExamples_Code_Documents_DocumentAliases_Default : CMSAPIExamplePage
{
    ...
    {
        // Document alias
        this.apiCreateDocumentAlias.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(CreateDocumentAlias);
        this.apiGetAndUpdateDocumentAlias.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndUpdateDocumentAlias);
        this.apiGetAndBulkUpdateDocumentAliases.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(GetAndBulkUpdateDocumentAliases);
        this.apiDeleteDocumentAlias.RunExample += new CMSAPIExamples_Controls_APIExample.OnRunExample(DeleteDocumentAlias);
    }
    ...
    public override void RunAll()
    {
        ...
        // Document alias
        this.apiCreateDocumentAlias.Run();
        this.apiGetAndUpdateDocumentAlias.Run();
        this.apiGetAndBulkUpdateDocumentAliases.Run();
    }
    ...
    public override void CleanUpAll()
    {
        ...
        // Document alias
        this.apiDeleteDocumentAlias.Run();
    }
