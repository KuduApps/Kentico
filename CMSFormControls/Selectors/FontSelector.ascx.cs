...
public partial class CMSFormControls_Selectors_FontSelector : FormEngineUserControl
{
    ...
    string mDefaultFont = "Arial";
    string mDefaultStyle = "Regular";
    int mDefaultSize = 11;
    bool mDisplayClearButton = true;
    ...
    private void registerScripts()
    {
        ...
        string postBack = this.Page.ClientScript.GetPostBackEventReference(this.hfValue, "");
